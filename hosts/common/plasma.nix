  ...
  config = lib.mkIf config.custom.plasma.enable {
    ...
    systemd.services."generate-mimeapps-file" = {
      ...
      script = ''
        ...
        video/*=org.videolan.VLC.desktop;
        application/x-matroska=org.videolan.VLC.desktop;
        application/epub+zip=com.calibre_ebook.calibre.ebook-viewer.desktop;org.kde.okular.desktop;com.calibre_ebook.calibre.desktop;com.calibre_ebook.calibre.ebook-edit.desktop;org.kde.ark.desktop;
