...
}:
{
  ...
  config = lib.mkIf config.custom.plasma.enable {
      ...
      systemPackages =
        let
          stable = with pkgs; [
            ...
            (callPackage ../../pkgs/kde-material-you-colors.nix { })
            (callPackage ../../pkgs/kde-wallpaper-effects-widget.nix { })
            (callPackage ../../pkgs/plasma-panel-colorizer.nix { })
                ...
                }
                {
                  ...
                  config = {
                    General = {
                      ...
                      #panelWidgets = ''`[{"id":25,"name":"org.kde.plasma.kickoff","title":"Application Launcher","icon":"nix-snowflake","inTray":false},{"id":26,"name":"org.dhruv8sh.kara","title":"kara","icon":"virtual-desktops","inTray":false},{"id":27,"name":"luisbocanegra.panel.colorizer","title":"Panel colorizer","icon":"desktop","inTray":false},{"id":28,"name":"org.kde.plasma.appmenu","title":"Global Menu","icon":"show-menu","inTray":false},{"id":29,"name":"luisbocanegra.panelspacer.extended","title":"Panel Spacer Extended","icon":"","inTray":false},{"id":30,"name":"org.kde.plasma.mediacontroller","title":"Media Player","icon":"media-playback-stopped-symbolic","inTray":false},{"id":31,"name":"com.github.antroids.application-title-bar","title":"Application Title Bar","icon":"window-close","inTray":false},{"id":32,"name":"org.kde.plasma.systemtray","title":"System Tray","icon":"preferences-desktop-notification","inTray":false},{"id":44,"name":"org.kde.plasma.digitalclock","title":"Digital Clock","icon":"preferences-system-time","inTray":false},{"id":45,"name":"org.kde.plasma.lock_logout","title":"Lock/Logout","icon":"system-shutdown","inTray":false},{"id":43,"name":"org.kde.plasma.systemmonitor","title":"System Monitor Sensor","icon":"ksysguardd","inTray":true},{"id":42,"name":"org.kde.plasma.volume","title":"Audio Volume","icon":"audio-volume-medium-symbolic","inTray":true},{"id":51,"name":"org.kde.plasma.networkmanagement","title":"Networks","icon":"network-wireless-80-symbolic","inTray":true},{"id":49,"name":"org.kde.plasma.battery","title":"Power and Battery","icon":"battery-full-symbolic","inTray":true},{"id":-1,"name":"org.kde.plasma.systemtray.expand","title":"Close popup","icon":"arrow-down","inTray":true}]`'';
                ...
                }
                {
                  ...
                  config = {
                    General = {
                      isEnabled = true;
                      hideWidget = true;
                      #panelWidgets = ''`[{"id":47,"name":"org.kde.plasma.icontasks","title":"Icons-Only Task Manager","icon":"preferences-system-windows","inTray":false},{"id":48,"name":"luisbocanegra.panel.colorizer","title":"Panel colorizer","icon":"desktop","inTray":false}]`'';
    ...
    systemd.services."generate-gestures-config" = {
      description = "Generate KWin Gestures Config";
      wantedBy = [ "multi-user.target" ];
      serviceConfig = {
        Type = "oneshot";
        User = "${isUser}";
      ...
      script = ''
          mkdir -p ~/.config
          cat << 'EOF' > ~/.config/kwingesturesrc
        [Gestures][Touchpad][0]
        Type=Hold
        Fingers=3
        TriggerWhenThresholdReached=true
        [Gestures][Touchpad][0][Hold]
        Threshold=1000
        [Gestures][Touchpad][0][Actions][0]
        Type=KeySequence
        [Gestures][Touchpad][0][Actions][0][KeySequence]
        Sequence=press LEFTMETA,press SPACE,release LEFTMETA,release SPACE
        EOF
      '';
    };
